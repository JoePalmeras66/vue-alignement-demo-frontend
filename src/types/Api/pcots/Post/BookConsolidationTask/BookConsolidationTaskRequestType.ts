...
export const BookConsolidationTaskRequestTypeValidator = z.object({
  taskId: z.string(),
...
export type BookConsolidationTaskRequestType = z.infer<
  typeof BookConsolidationTaskRequestTypeValidator
>
